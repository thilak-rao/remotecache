...
description: Install the self-hosted Nx remote cache server on Kubernetes with the Helm chart — OCI install, values reference, S3 IRSA, probes, TLS, graceful shutdown, and Recreate upgrades.
---
