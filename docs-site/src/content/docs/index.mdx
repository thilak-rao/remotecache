...
<CardGrid>
  <Card title="Free & MIT" icon="approve-check">
    No per-seat fees, no Commercial license. Run it yourself. The official `@nx/*-cache` plugins shipped under a Commercial license; this one is MIT.
  </Card>
  <Card title="Trust-boundary tokens" icon="shield">
    `readonly` for untrusted CI, `full` for trusted pipelines. Untrusted PRs can't write, so they can't poison the cache. [See CVE-2025-36852](/security/cve-2025-36852/).
  </Card>
