  ...
  - tag: script
    ...
    content: |
      {"@context":"https://schema.org","@type":"FAQPage","mainEntity":[
        ...
        {"@type":"Question","name":"Why does /ready return 503 Not Ready?","acceptedAnswer":{"@type":"Answer","text":"The readiness probe reads the operational id, value, and permission columns from the existing SQLite tokens table, then probes the configured cache backend. A missing or damaged tokens table makes readiness fail. For filesystem storage, it checks CACHE_DIR. The specific runtime failure is written to the server logs."}},
