...
| `CACHE_TTL_HOURS`           | no       | —                                      | Positive number of hours for the filesystem cache TTL; the sweep deletes entries not accessed within the window. Filesystem strategy only. |
